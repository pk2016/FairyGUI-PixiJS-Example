...
define(["require", "exports", "./LoadingView", "./WindowA", "./WindowB", "./WindowWait"], function (require, exports, LoadingView_1, WindowA_1, WindowB_1, WindowWait_1) {
    ...
    var Main = /** @class */ (function (_super) {
        ...
        Main.prototype.initDemo = function (name, ins) {
            ...
            switch (name) {
                case "text":
                    ...
                    this.ticker.add(this.textResizeHandler, this);
                    break;
                case "window":
                    this.playWindow(ins);
                    break;
                ...
                case "progressbar":
                    ...
                    this.ticker.add(this.progressDemoHandler, this);
                    break;
                case "depth":
        ...
        Main.prototype.disposeDemo = function () {
            ...
            switch (ins.name) {
                case "progressbar":
                    this.ticker.remove(this.progressDemoHandler, this);
                    this.progressDemoHandler = null;
                    break;
                case "text":
                    this.ticker.remove(this.textResizeHandler, this);
